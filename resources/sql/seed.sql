...
DROP TABLE IF EXISTS userClans CASCADE;
...
CREATE TABLE userClans (
    ...
    clanID INTEGER NOT NULL REFERENCES clans
);
...
CREATE TABLE notifications (
    ...
    sharePostID INTEGER,
    shareUserID INTEGER,
    FOREIGN KEY (likePostID, likeUserID) REFERENCES "likes"(postID, userID),
    FOREIGN KEY (sharePostID, shareUserID) REFERENCES shares (postID, userID),
...
CREATE INDEX post_user ON posts USING hash(userID);
CREATE INDEX post_id ON posts USING hash(id);
CREATE INDEX share_post ON shares USING hash(postID);
CREATE INDEX share_user ON shares USING hash(userID);
CREATE INDEX userClan_user ON userClans USING hash(userID);
CREATE INDEX userClan_clan ON userClans USING hash(clanID);
...
CREATE INDEX message_search ON "messages" USING GIN (to_tsvector('english', messageText));
...
DECLARE
    posting_user_id INT;
BEGIN
    SELECT "users".id INTO posting_user_id FROM "users", posts  WHERE "users".id = posts.userID AND posts.id = New.postID;
...
INSERT INTO clans(name, description, ownerID) 
...
INSERT INTO userClans(userID, clanID) VALUES(1, 1);
INSERT INTO userClans(userID, clanID) VALUES(2, 2);
INSERT INTO userClans(userID, clanID) VALUES(3, 1);
INSERT INTO userClans(userID, clanID) VALUES(4, 3);
INSERT INTO userClans(userID, clanID) VALUES(5, 4);
INSERT INTO userClans(userID, clanID) VALUES(6, 1);
INSERT INTO userClans(userID, clanID) VALUES(7, 5);
INSERT INTO userClans(userID, clanID) VALUES(8, 2);
INSERT INTO userClans(userID, clanID) VALUES(9, 3);
INSERT INTO userClans(userID, clanID) VALUES(10, 3);


INSERT INTO posts ("date", content, hasImg, userID, clanID) 
...
INSERT INTO "likes"(postID, userID, "date") VALUES(1, 4, '2019-04-01 19:27:12');
INSERT INTO "likes"(postID, userID, "date") VALUES(1, 7, '2019-03-01 09:21:17');
INSERT INTO "likes"(postID, userID, "date") VALUES(1, 17, '2019-02-01 16:14:34');
INSERT INTO "likes"(postID, userID, "date") VALUES(2, 11, '2019-01-01 22:38:58');
INSERT INTO "likes"(postID, userID, "date") VALUES(2, 4, '2019-02-01 17:52:43');
INSERT INTO "likes"(postID, userID, "date") VALUES(3, 5, '2019-03-01 09:42:01');
INSERT INTO "likes"(postID, userID, "date") VALUES(3, 7, '2019-01-14 21:38:51');
INSERT INTO "likes"(postID, userID, "date") VALUES(4, 13,'2019-02-17 17:27:22');
INSERT INTO "likes"(postID, userID, "date") VALUES(5, 15, '2019-03-09 09:35:34');
INSERT INTO "likes"(postID, userID, "date") VALUES(6, 2, '2019-03-02 09:57:52');
INSERT INTO "likes"(postID, userID, "date") VALUES(7, 18, '2019-01-17 13:23:36');
INSERT INTO "likes"(postID, userID, "date") VALUES(8, 20, '2019-04-19 06:55:44');
INSERT INTO "likes"(postID, userID, "date") VALUES(9, 10, '2019-04-24 16:41:18');
INSERT INTO "likes"(postID, userID, "date") VALUES(10, 6, '2019-03-27 19:24:15');
INSERT INTO "likes"(postID, userID, "date") VALUES(11, 1, '2019-03-30 23:19:30');
INSERT INTO "likes"(postID, userID, "date") VALUES(12, 7, '2019-02-06 11:33:46');
INSERT INTO "likes"(postID, userID, "date") VALUES(13, 14, '2019-02-14 12:57:12');
INSERT INTO "likes"(postID, userID, "date") VALUES(13, 17, '2019-01-21 14:42:27');
INSERT INTO "likes"(postID, userID, "date") VALUES(13, 11, '2019-03-17 22:15:34');
INSERT INTO "likes"(postID, userID, "date") VALUES(13, 4, '2019-04-01 09:31:18');


INSERT INTO shares(postID, userID, content, "date") VALUES (2, 10, 'bump to this!', '2019-03-31 09:23:14');
INSERT INTO shares(postID, userID, content, "date") VALUES (3, 6, 'So funny!', '2019-02-21 09:29:10');
INSERT INTO shares(postID, userID, content, "date") VALUES (12, 3, 'I agree with you', '2019-01-19 09:29:41');
INSERT INTO shares(postID, userID, content, "date") VALUES (5, 19, 'Case terminated!', '2019-02-22 09:12:23');
INSERT INTO shares(postID, userID, content, "date") VALUES (10, 4, 'This information is so wrong!', '2019-04-01 19:22:53');
INSERT INTO shares(postID, userID, content, "date") VALUES (15, 5, 'This post is so nice!', '2019-04-02 23:42:10');
INSERT INTO shares(postID, userID, content, "date") VALUES (2, 12, 'I agree with you!', '2019-04-03 23:35:14');
INSERT INTO shares(postID, userID, content, "date") VALUES (9, 3, 'It is like S d i S', '2019-04-15 13:14:32');
INSERT INTO shares(postID, userID, content, "date") VALUES (3, 7, 'Just tomorrow', '2019-05-01 15:34:24');
INSERT INTO shares(postID, userID, content, "date") VALUES (7, 2, 'I do not agree', '2019-05-12 18:22:10');


INSERT INTO comments(postID, userID, "date", commentText) 
...
INSERT INTO messages(sender, receiver, "date", messageText, hasBeenSeen) 
...
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (3, 12, NULL, 'friendRequest', '2019-04-16 23:23:59', TRUE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (11, 14, 1, 'clanRequest', '2019-03-11 09:37:20', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (7, 20, 2, 'clanRequest', '2019-04-12 19:45:56', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (8, 11, NULL, 'friendRequest', '2019-03-16 13:25:26', TRUE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (4, 2, NULL, 'friendRequest', '2019-04-02 09:18:01', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (11, 3, 2, 'clanRequest', '2019-02-06 14:27:16', TRUE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (8, 1, NULL, 'friendRequest', '2019-03-16 16:21:17', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (5, 11, 4, 'clanRequest', '2019-02-19 10:32:39', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (4, 4, 3, 'clanRequest', '2019-02-23 06:12:20', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (2, 10, NULL, 'friendRequest', '2019-01-26 15:16:22', TRUE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (3, 10, NULL, 'friendRequest', '2019-01-27 05:51:12', TRUE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (3, 13, NULL, 'friendRequest', '2019-01-27 13:46:47', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (4, 13, NULL, 'friendRequest', '2019-01-27 17:34:16', TRUE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (3, 15, NULL, 'friendRequest', '2019-01-28 06:23:34', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (3, 11, NULL, 'friendRequest', '2019-01-28 12:47:27', TRUE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (4, 10, NULL, 'friendRequest', '2019-01-28 13:57:24', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (5, 10, NULL, 'friendRequest', '2019-01-28 18:26:56', TRUE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (5, 12, NULL, 'friendRequest', '2019-01-29 02:32:35', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (6, 13, NULL, 'friendRequest', '2019-01-29 09:35:16', FALSE);
INSERT INTO requests(sender, receiver, clanID, "type", "date", hasAccepted) VALUES (7, 13, NULL, 'friendRequest', '2019-01-30 01:21:39', TRUE);


INSERT INTO blockeds(userID, admin, "date", motive) VALUES (13, 4, '2019-03-21 07:22:16', 'Racism');
INSERT INTO blockeds(userID, admin, "date", motive) VALUES (15, 4, '2019-04-01 21:42:32', 'Inappropriate behaviour');
INSERT INTO blockeds(userID, admin, "date", motive) VALUES (7, 4, '2019-03-27 19:32:15', 'Abusive content');
INSERT INTO blockeds(userID, admin, "date", motive) VALUES (9, 4, '2019-03-23 12:13:20', 'Inappropriate behaviour');
INSERT INTO blockeds(userID, admin, "date", motive) VALUES (18, 4, '2019-03-31 05:16:33', 'Inappropriate behaviour');


INSERT INTO reports(sender, admin, "date", reportText, commentID, postID, motive) 
...
INSERT INTO notifications("date", requestID, messageID, commentID, likePostID, likeUserID, sharePostID, shareUserID, hasBeenSeen) 
