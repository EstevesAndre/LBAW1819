...
function addedCommentHandler() {
    ...
    comment_area.innerHTML = '<div class="d-flex align-items-center comment" id="' + comment.id + '"><span class="comment-avatar float-left mr-2"><a href="/user/' + comment.username + '"><img class="rounded-circle bg-warning" src="' + path_header + '/avatars/' + comment.race + '_' + comment.class + '_' + comment.gender + '.bmp" alt="Avatar"></a></span><div class=w-90 comment-data pl-1 pr-0"><p class="pt-3">' + comment.comment_text + '</p></div><span class="ml-2 delete-comment" id="' + comment.id + '"><a><i class="fas fa-times"></i></a></span></div>';
