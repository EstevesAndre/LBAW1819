...
//     retorno += '<div class="container share mt-4 mb-2 p-0" data-id="' + share.post_id + '-' + user_share.id  + '">'
// <div class="cardbox text-left shadow-lg bg-white">
// <div class="cardbox-heading">
// <div class="dropdown float-right mt-3 mr-3">
...
// //VESJ ANVAUNWBUANRWOVIUNONJVSNBOFUNBOWEUVNOWUVNOUNVCOUWN
// </div>
// </div>
    ...
    return ''
        ...
        + '<div class="media m-0">'
        + '<div class="d-flex m-3">'
        + '<a class="mx-1 my-1" href="/user/' + user_post.username + '">'
        + '<img class="img-fuild rounded-circle"'
        + 'src="' + path_header + '/avatars/' + user_post.race + '_' + user_post.class + '_' + user_post.gender + '.bmp"'
        + 'alt="User">'
        + '</a>'
        + '</div>'
        + '<div class="media-body ml-1 align-self-center">'
